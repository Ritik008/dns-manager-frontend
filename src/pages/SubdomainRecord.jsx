  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="flex items-end justify-end mb-3">
        <Link to={`/edit-subdomain/${id}/records/${domainValue.name}`} class="ml-3 border border-gray-500 hover:bg-blue-600 hover:border-none hover:text-white font-bold py-2 px-4 rounded">
          Edit
        </Link>
